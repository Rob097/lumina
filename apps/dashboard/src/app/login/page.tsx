    ...
    <main className="auth-wrap">
      <div className="auth-shell">
        ...
        <div className="auth-formside">
          ...
          {/* Google OAuth isn't configured yet — keep the action wired but render the
              button disabled so it can't trigger an oauth_failed error. Re-enable by
              dropping `disabled` once the provider is set up in Supabase. */}
          <form action={signInWithGoogle}>
            ...
            >
              ...
              <span className="auth-google-soon">Coming soon</span>
            </button>
          </form>
