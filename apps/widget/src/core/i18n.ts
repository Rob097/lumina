...
const en: StringTable = {
  ...
  'draw.hint': 'Draw on the photo to mark where it should go (optional)',
  'draw.undo': 'Undo',
  'draw.clear': 'Clear',
  'placement.auto': 'Auto',
...
const it: StringTable = {
  ...
  'draw.hint': 'Disegna sulla foto per indicare dove posizionarlo (facoltativo)',
  'draw.undo': 'Annulla',
  'draw.clear': 'Cancella',
  'placement.auto': 'Auto',
...
const de: StringTable = {
  ...
  'draw.hint': 'Zeichne aufs Foto, um zu markieren, wohin (optional)',
...
const fr: StringTable = {
  ...
  'draw.hint': 'Dessinez sur la photo pour indiquer où le placer (facultatif)',
  'draw.undo': 'Annuler',
  'draw.clear': 'Effacer',
  'placement.auto': 'Auto',
...
const es: StringTable = {
  ...
  'draw.hint': 'Dibuja en la foto para marcar dónde colocarlo (opcional)',
  'draw.undo': 'Deshacer',
  'draw.clear': 'Borrar',
  'placement.auto': 'Auto',
