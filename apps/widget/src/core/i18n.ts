...
const en: StringTable = {
  ...
  'legal.notice': 'Your photo is processed by YuzuView and kept up to 30 days (results 90).',
  ...
  'result.estimate': 'AI estimate: ~{qty}',
  'result.estimateNote': 'An estimate — adjust the quantity if needed.',
  'result.less': 'Decrease quantity',
  'result.more': 'Increase quantity',
...
const it: StringTable = {
  ...
  'legal.notice': 'Le tue foto sono elaborate da YuzuView e conservate fino a 30 giorni (risultati 90).',
  'legal.privacy': 'Privacy e termini',
  'guide.cta': 'Continua',
  ...
  'generating.subtitle': 'Di solito richiede 1–2 minuti.',
  ...
  'result.estimate': 'Stima AI: ~{qty}',
  'result.estimateNote': 'È una stima — modifica la quantità se necessario.',
  'result.less': 'Diminuisci quantità',
  'result.more': 'Aumenta quantità',
...
const de: StringTable = {
  ...
  'legal.notice': 'Dein Foto wird von YuzuView verarbeitet und bis zu 30 Tage gespeichert (Ergebnisse 90).',
  ...
  'generating.subtitle': 'Das dauert in der Regel 1–2 Minuten.',
  ...
  'result.estimate': 'KI-Schätzung: ~{qty}',
  'result.estimateNote': 'Eine Schätzung — passe die Menge bei Bedarf an.',
  'result.less': 'Menge verringern',
  'result.more': 'Menge erhöhen',
...
const fr: StringTable = {
  ...
  'legal.notice': 'Votre photo est traitée par YuzuView et conservée jusqu’à 30 jours (résultats 90).',
  'legal.privacy': 'Confidentialité & conditions',
  'guide.cta': 'Continuer',
  ...
  'generating.subtitle': 'Cela prend généralement 1 à 2 minutes.',
  ...
  'result.estimate': 'Estimation IA : ~{qty}',
  'result.estimateNote': 'Une estimation — ajustez la quantité si besoin.',
  'result.less': 'Diminuer la quantité',
  'result.more': 'Augmenter la quantité',
  'feedback.up': 'Superbe',
...
const es: StringTable = {
  ...
  'legal.notice': 'Tu foto es procesada por YuzuView y se conserva hasta 30 días (resultados 90).',
  'legal.privacy': 'Privacidad y términos',
  'guide.cta': 'Continuar',
  ...
  'generating.subtitle': 'Esto suele tardar 1–2 minutos.',
  ...
  'result.estimate': 'Estimación IA: ~{qty}',
  'result.estimateNote': 'Es una estimación: ajusta la cantidad si hace falta.',
  'result.less': 'Disminuir cantidad',
  'result.more': 'Aumentar cantidad',
