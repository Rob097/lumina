...
export const STRING_KEYS = [
  ...
  'confirm.instructionsPlaceholder',
  'placement.auto',
  'placement.floor',
  'placement.wall',
  'placement.table',
...
const en: StringTable = {
  ...
  'confirm.instructions': 'Add specific instructions (optional)',
  'confirm.instructionsPlaceholder': 'e.g. place it near the window, facing the room',
  'placement.auto': 'Auto',
...
const it: StringTable = {
  ...
  'camera.capture': 'Scatta foto',
  'confirm.title': 'Posiziona {product}',
  'confirm.placementLabel': 'Dove vuoi metterlo?',
  'confirm.generate': 'Genera anteprima',
  'confirm.instructions': 'Aggiungi istruzioni specifiche (facoltativo)',
  'confirm.instructionsPlaceholder': 'es. mettilo vicino alla finestra, rivolto verso la stanza',
  'placement.auto': 'Auto',
...
const de: StringTable = {
  ...
  'confirm.instructions': 'Spezifische Anweisungen hinzufügen (optional)',
  'confirm.instructionsPlaceholder': 'z. B. neben das Fenster stellen, zum Raum gewandt',
  'placement.auto': 'Auto',
...
const fr: StringTable = {
  ...
  'confirm.instructions': 'Ajouter des instructions spécifiques (facultatif)',
  'confirm.instructionsPlaceholder': 'ex. près de la fenêtre, face à la pièce',
  'placement.auto': 'Auto',
...
const es: StringTable = {
  ...
  'confirm.instructions': 'Añadir instrucciones específicas (opcional)',
  'confirm.instructionsPlaceholder': 'p. ej. junto a la ventana, mirando a la habitación',
  'placement.auto': 'Auto',
