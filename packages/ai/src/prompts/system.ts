...
export const COMPOSE_SYSTEM_INSTRUCTION_FASHION = [
  ...
  '',
  'ANALYZE BEFORE YOU RENDER (reason step by step):',
  '1. Pick ONE arm to carry the accessory on — the arm that is most free (e.g. on a mirror selfie, the one NOT',
  '   holding the phone; if BOTH hands hold the phone, choose ONE forearm). Decide how the accessory is carried',
  '   on THAT single arm — a handbag hangs from the hand by its handle/strap, OR the handle loops over the',
  '   forearm and the bag rests in the crook of the elbow, whichever fits the handle and the pose.',
