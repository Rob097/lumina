...
export const COMPOSE_SYSTEM_INSTRUCTION_FASHION = [
  ...
  ' fused into the clothing, fingers passing through the handle, wrong scale (too large or small for the hand),',
  ' duplicated accessory, changed product color, cartoonish look, altered background.',
].join('\n');
